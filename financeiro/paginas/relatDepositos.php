...
<div class="space-y-6">
	...
	<header>
		<h1 class="text-xl font-semibold text-slate-900">Relatório de Depósitos</h1>
		<p class="mt-1 text-sm text-slate-500">Depósitos realizados em um período</p>
	</header>

	<form action="?s=relatDepositos" method="post" class="bg-white rounded-xl ring-1 ring-slate-200 p-6">
	...
	<section class="bg-white rounded-xl ring-1 ring-slate-200 overflow-hidden">
		<div class="px-6 py-4 border-b border-slate-100">
			<h2 class="text-base font-semibold text-slate-900">Resumo</h2>
		</div>
		<?php $relatorio->DepositosRealizadosResumo($dataInicio,$dataFim); ?>
	</section>
	...
	<section class="bg-white rounded-xl ring-1 ring-slate-200 overflow-hidden">
		...
		<?php $relatorio->DepositosRealizados($dataInicio,$dataFim); ?>
	</section>

...
<h1 class="page-header">Relatório de Forma de Pagamento</h1>
<form class="form-inline" role="form" style="padding:20px;" action="?s=relatPagamento" method="post">
		...
		<div class="form-group" style="margin-right:10px;">
        	<label for="txtPagamento">Pagamento:&nbsp;</label>
            	<select class="form-control" style="width:200px" id="txtPagamento" name="txtPagamento">				

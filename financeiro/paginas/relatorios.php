...
<form class="form-inline" role="form" style="padding:20px;" action="?s=relatorios" method="post">
		
		<div class="form-group" style="margin:10px;">		
		<div class="form-group">
		<label for="txtDataInicio">Período:&nbsp;</label>
		<input type="<?php $typeData; ?>" data-provide="datepicker" class="form-control" onkeyup="Formatadata(this,event)" id="txtDataInicio" name="txtDataInicio" placeholder="" style="width:160px;" value="<?php echo $dataInicio; ?>">
		</div>
		<div class="form-group">
		<label for="txtDataFim">&nbsp;&nbsp; à&nbsp;&nbsp; </label>
		<input type="<?php $typeData; ?>" data-provide="datepicker" class="form-control" onkeyup="Formatadata(this,event)" id="txtDataFim" name="txtDataFim" placeholder="" style="width:160px;" value="<?php echo $dataFim; ?>">
		</div>		
		</div>
		...
		<input type="text" class="form-control" id="txtPaciente" name="txtPaciente" placeholder="" style="width:200px;" value="<?php echo $paciente; ?>">
		</div>		
		</div>
